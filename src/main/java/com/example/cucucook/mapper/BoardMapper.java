...
public interface BoardMapper {
    ...
    List<Board> getBoardList(@Param("division") String division, @Param("search") String search, @Param("searchType") String searchType, @Param("boardCategoryId") String boardCategoryId, @Param("start") Integer start, @Param("display") Integer display);
