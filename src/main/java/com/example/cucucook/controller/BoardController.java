...
public class BoardController {
  ...
  public ApiResponse<List<Board>> getBoardList(@RequestParam String search, @RequestParam String searchType, @RequestParam String boardCategoryId,
    ...
    return boardService.getBoardList(search, searchType, boardCategoryId, start, display);
  }
